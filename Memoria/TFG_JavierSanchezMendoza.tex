...
\begin{figure}[H]
\centering
\subfigure[Mapa web]{\includegraphics[width=60mm]{interfaz/04-15/0.png}}
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Metodo} & \textbf{Url}            & \textbf{Descripción}                                               \\ \hline
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.35]{diseno/ComponentsDiagram.png}
\caption{Diagrama UML 1}
\end{figure}


\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.3]{diseno/ComponentDiagram2.png}
\caption{Diagrama UML 2}
\end{figure}
