...
\section{Desarrollo}
El código fuente de la aplicación desarrollada la cual se detalla a continuación, se encuentra disponible en un repositorio publico de \textit{GitHub}: \url{https://github.com/jsanchezmend/TFGAntivacunas/tree/master/YouTubeCrawlerTool}.
\bigskip
