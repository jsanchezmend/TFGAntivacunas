...
//Explicar eleccion de YouTube Data API

//Explicar estructuracion de los servicios, busqueda para obtener id's y luego acesso por recurso

//Explicar la search api y los criterios de busqueda escoguidos.

//Explicar el uso de cuotas y porque es importante solicitar el minimo numero de campos

//Exponer las apis de videos y canales y los campos recuperados de cada uno
